...
When evaluating a new post, perform the following analysis.

Step 1.
Understand the semantic content of the image.
...
Analyze the textual information.
...
If unavailable, ignore these features.
